...
def build_interactive_english_home():
    ...
    replacements = [
        ...
        # Final cleanup for strings that can become mixed after earlier generic replacements.
        ('현재 상태와 Upcoming Fixtures를 한 페이지에서 봅니다.','See current form and upcoming fixtures on one page.'),
        ('향후 5 matches xPts','Next 5 xPts'),
        ('향후 5 matches','Next 5 Matches'),
