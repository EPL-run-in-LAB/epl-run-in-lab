...
def build_interactive_english_home():
    ...
    replacements = [
        ...
        ('<h1 id="teamPageTitle">팀 분석</h1>','<h1 id="teamPageTitle">Team Analysis</h1>'),('Current form and 향후 일정을 on one page.','See current form and upcoming fixtures on one page.'),('현재 승점','Current Points'),('Next 5 matches xPts','Next 5 xPts'),('모델이 보는 현재 경기력','Current Model Form'),('Next 5 matches','Next 5 Matches'),
